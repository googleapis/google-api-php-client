...
class Google_Service_Datastore_Datasets_Resource extends Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Google_Service_Datastore_BlindWriteResponse
   */
  public function blindWrite($datasetId, Google_Service_Datastore_BlindWriteRequest $postBody, $optParams = array())
  {
    $params = array('datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('blindWrite', array($params), "Google_Service_Datastore_BlindWriteResponse");
  }
  /**
...
class Google_Service_Datastore_BlindWriteRequest extends Google_Model
{
...
class Google_Service_Datastore_BlindWriteResponse extends Google_Model
{
  public $kind;
