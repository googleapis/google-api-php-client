...
class Google_Service_Customsearch extends Google_Service
{
    ...
    public function __construct(Google_Client $client)
    {
        ...
        $this->cse = new Google_Service_Customsearch_Cse_Resource(
            ...
            $this->serviceName,
            'cse',
            //example here: https://developers.google.com/apis-explorer/#s/customsearch/v1/search.cse.list?q=kermit+and+piggy
            array(
                'methods' => array(
                    'list' => array(
                        'path' => 'v1',
                        ...
                        'parameters' => array(
                            ...
                            //The sort expression to apply to the results (string)
                            'sort' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            ...
                            //Creates a range in form as_nlo value..as_nhi value and attempts to append it to query (string)
                            'highRange' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Number of search results to return (integer)
                            'num' => array(
                                'location' => 'query',
                                'type' => 'integer',
                            ),
                            //Country restrict(s). (string)
                            'cr' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Returns images of a type, which can be one of: clipart, face, lineart, news, and photo. (string)
                            'imgType' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Geolocation of end user. (string)
                            'gl' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            ...
                            //Specifies the search type: image. (string)
                            'searchType' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Returns images of a specified type. Some of the allowed values are: bmp, gif, png, jpg, svg, pdf, ... (string)
                            'fileType' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //The index of the first result to return (integer)
                            'start' => array(
                                'location' => 'query',
                                'type' => 'integer',
                            ),
                            //Returns images of a specific dominant color: yellow, green, teal, blue, purple, pink, white, gray, black and brown. (string)
                            'imgDominantColor' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //The language restriction for the search results (string)
                            'lr' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Specifies all search results should be pages from a given site (string)
                            'siteSearch' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //The URL of a linked custom search engine (string)
                            'cref' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Specifies all search results are from a time period (string)
                            'dateRestrict' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Search safety level (string)
                            'safe' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Turns off the translation between zh-CN and zh-TW. (string)
                            'c2coff' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //The local Google domain to use to perform the search. (string)
                            'googlehost' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Appends the extra query terms to the query. (string)
                            'hq' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            ...
                            //Sets the user interface language. (string)
                            'hl' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            ...
                            //Returns images of a specified size, where size can be one of: icon, small, medium, large, xlarge, xxlarge, and huge. (string)
                            'imgSize' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Returns black and white, grayscale, or color images: mono, gray, and color. (string)
                            'imgColorType' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            //Filters based on licensing. Supported values include: cc_publicdomain, cc_attribute, cc_sharealike, cc_noncommercial, cc_nonderived and combinations of these. (string)
                            'rights' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            ...
                            //Controls turning on or off the duplicate content filter. (string)
                            'filter' => array(
                                'location' => 'query',
                                'type' => 'string',
                            ),
                            ...
                            //Controls whether to include or exclude results from the site named in the as_sitesearch parameter (string)
